...
namespace Serving {
  ...
  public:
     ...
     */
    grpc::Status SetBatchSize(
        grpc::ServerContext *ctx, const AdminRequest *req,
     ...
     */
    grpc::Status Connect(
        grpc::ServerContext *ctx, const ConnectionRequest *req,
     ...
     */
    grpc::Status Process(
        grpc::ServerContext *ctx, const TensorMessage *req,
